...
public class Map {
	...
	protected static BitMap		tile		= BitMap
	        .load("/art/floor/tile.png");
	protected static BitMap[][]	house		= BitMap
	        .cut("/art/house/houseOne.png", 64, 64, 0, 0);
	protected static BitMap		tree		= BitMap.load("/art/wall/tree.png");
	protected static BitMap		flowers		= BitMap
	        .load("/art/floor/flowersOne.png");
	private String				name;
